...
// #12 Write function getValueOfProperty that takes in an object, and the name of a property on 
//the object
// return the value from the object that corresponds to the property
function getValueOfProperty(objec, name){
	objec.name = name;
	return objec.name; 
...
// 	this.author = author;
// 	this.date = new Date();
// 	// console.log(makeChatMessage("nate", "hi"))
// }

// var obje = new MakeChatMessage("hi", "nate");
// console.log(obje);
...
// #14 Create a function called coderTest that takes in an object that is a person. It looks 
// to see if the person’s name is Jeremy and then changes the person object to have a property 
//called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.  otherwise set 
//lovesCode to 5.
...
/*
    ...
    temperature over 80 and humidity under 40 and cloudiness under 20 - return "I'm literally in
	 the desert"
